Here’s the **English version** of your EggNOG-mapper workflow, written in clean Markdown format suitable for display on **GitHub** (e.g., in a `README.md` or documentation page).
